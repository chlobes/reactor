...
const drawReactor = () => {
	...
	reactor_ctx.fillRect(5, 35, 20, 120);
	...
	reactor_ctx.fillRect(5, 155, 20, -60*Math.min(reactor.fuel(), 2.0));
	if (reactor.fuel() > 2) {
		reactor_ctx.fillStyle = RED;
		reactor_ctx.fillRect(5, 35, 20, -30*(reactor.fuel() - 2.0));
	}
	reactor_ctx.fillRect(30, 155, 20, -60*Math.min(reactor.neutrons(), 2.0));
	if (reactor.neutrons() > 2) {
		reactor_ctx.fillStyle = RED;
		reactor_ctx.fillRect(30, 35, 20, -30*(reactor.neutrons() - 2.0));
	}
};
